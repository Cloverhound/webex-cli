...
func init() {
	...
	{ // create
		...
		cmd.Flags().StringVar(&orgid, "orgid", "", "Webex Identity assigned organization identifier for the user's organization or the organization he manages.")
	...
	{ // list
		...
		cmd.Flags().StringVar(&orgid, "orgid", "", "The organization ID.")
		cmd.MarkFlagRequired("orgid")
