...
var slidosecurepremiumCmd = &cobra.Command{
	Use:   "slidosecurepremium",
	Short: "Slidosecurepremium commands",
}

func init() {
	cmd.MeetingsCmd.AddCommand(slidosecurepremiumCmd)
...
`,
		...
		slidosecurepremiumCmd.AddCommand(cmd)
	}
