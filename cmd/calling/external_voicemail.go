...
var externalVoicemailCmd = &cobra.Command{
	Use:   "external-voicemail",
	Short: "ExternalVoicemail commands",
}

func init() {
	cmd.CallingCmd.AddCommand(externalVoicemailCmd)
	...
	{ // update-clear-message-waiting-indicator
		var id string
		var orgId string
		var action string
		var bodyRaw string
