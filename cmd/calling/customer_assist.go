...
var customerAssistCmd = &cobra.Command{
	Use:   "customer-assist",
	Short: "CustomerAssist commands",
}

func init() {
	cmd.CallingCmd.AddCommand(customerAssistCmd)
	...
	{ // list-wrap-up-reasons
		...
		customerAssistCmd.AddCommand(cmd)
	}
	...
	{ // list-available-agents
		...
		cmd.MarkFlagRequired("location-id")
		cmd.Flags().StringVar(&orgId, "org-id", "", "The organization ID of the customer or partner's organization.")
		cmd.Flags().StringVar(&hasCxEssentials, "has-cx-essentials", "", "Returns only the list of available agents with Customer Assist license when `true`, otherwise returns the list of available agents with Customer Experience Basic license.")
		customerAssistCmd.AddCommand(cmd)
	}
