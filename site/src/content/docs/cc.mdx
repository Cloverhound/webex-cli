...
The CLI provides streamlined download and upload commands for CC audio files and agent personal greetings. These use multipart/form-data uploads and binary downloads — the generated CRUD commands only handle metadata.

### Audio Files

```bash
# Download an audio file to disk
